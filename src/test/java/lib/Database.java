...
public class Database {
   ...
   private String url;
    ...
    //Check that user created in DB
    /*public boolean isUserCreatedInDB(String username, String pass) {
    	String usernameFromDB;
    	String passFromDB;
    	usernameFromDB = db.selectValue("SELECT username from TABLE where username='" + username + "'");
    	passFromDB = db.selectValue("SELECT pass from TABLE where username='" + username);
